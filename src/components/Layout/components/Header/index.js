...
import { faXmarkCircle, faMagnifyingGlass, faPlus, faEllipsisVertical } from '@fortawesome/free-solid-svg-icons';
        ...
        <header className={cx('wrapper')}>
            <div className={cx('inner')}>
                ...
                <div className={cx('action')}>
                    {currentUser ? (
                        <>
                            ...
                            <Tippy
                                placement="bottom"
                                render={(attrs) => (
                                    <div className={cx('inbox-result')} tabIndex="-1" {...attrs}>
                                        Inbox
                                    </div>
                                )}
                            >
                    ...
                    <More items={currentUser ? userMoreItems : moreItems}>
                        {currentUser ? (
                            <Image
                                className={cx('avatar')}
                                src="https://p16-sign-va.tiktokcdn.com/tos-maliva-avt-0068/42a81079b5885e152707b170d63ba2df~c5_100x100.jpeg?x-expires=1688896800&x-signature=UiqLlFPDytrLR4x%2BOVwVv51WV1M%3D"
                            />
                        ) : (
